...
// Highlight function for dynamic/form data
#let form_data(body) = {
...
(cognome del minore) #form_data[{{ minor_last_name.as_deref().unwrap_or("") }}] (nome del minore) #form_data[{{ minor_first_name.as_deref().unwrap_or("") }}] \
nato a #form_data[{{ minor_birth_place.as_deref().unwrap_or("") }}] (#form_data[{{ minor_birth_province.as_deref().unwrap_or("") }}]), il #form_data[{{ minor_birth_date.as_deref().unwrap_or("") }}], residente a #form_data[{{ minor_residence_city.as_deref().unwrap_or("") }}] \
in Via/Piazza #form_data[{{ minor_residence_address.as_deref().unwrap_or("") }}] n° #form_data[{{ minor_residence_number.as_deref().unwrap_or("") }}] CAP #form_data[{{ minor_residence_cap.as_deref().unwrap_or("") }}] Prov. #form_data[{{ minor_residence_province.as_deref().unwrap_or("") }}] \
Codice Fiscale #form_data[{{ minor_fiscal_code.as_deref().unwrap_or("") }}]
